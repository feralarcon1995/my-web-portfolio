  ...
  const workData = [
    {
      ...
      descrip: 'Web realizada como proyecto final en el curso de desarrollo web en coderhouse, en el cual es un tributo a la banda de rock alternativo de Estados Unidos llamada Linkin Park. En este proyecto encontraras, informacion de la banda, discos , una galeria. El maquetado se realizo con HTML5, CSS y SASS para los estilos, bootstrap para un mayor dinamismo, es totalmente responsive, se adapta a la pantalla de todos los dispositivos, cuenta con seo y esta optimizado.',
    ...
    },
    {
      ...
      descrip: 'Web realizada como proyecto final en el curso de Javascript en coderhouse, el cual es un simulador de gastos con la tematica de viajes. En este proyecto encontraras, informacion de distintos destinos, en el cual haciendo ciertas combinaciones encontras descuentos. El maquetado se realizo con HTML5, CSS y SASS para los estilos, javascript para manejo del DOM y junto a la api del dolar podes ver actualizado el precio del mismo en el momento que visites la pagina, es totalmente responsive, se adapta a la pantalla de todos los dispositivos, cuenta con seo y esta optimizado.',
    ...
    },
    {
      ...
      descrip: 'Web realizada para clase de sass, mostrando como pasar un css armado a codigo sass para compilar correctamente, anidacion y estructura de sass.',
    ...
    },
    {
      ...
      descrip: 'Web realizada como proyecto final en el curso de Python en coderhouse, el cual es un Blog de Mascotas hecho en Django. En este proyecto encontraras, un registro, login, podras postear a tu mascota para presumirla,darla en adopcion o incluso adoptar, dando like a post, comentandolos y siguiendo usuarios. En este proyecto se utilizo Sqlite3 para crear la base de datos, se usaron templates HTML para renderizar los datos, un crud para editar perfil, post y comentarios,es totalmente responsive, se adapta a la pantalla de todos los dispositivos, cuenta con seo y esta optimizado.',
